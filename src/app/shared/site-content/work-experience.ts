...
const workExperienceEn: Array<ICompanyExperience> = [{
  title: 'Accenture',
...
const workExperienceHi: Array<ICompanyExperience> = [{
  title: 'एक्सेंचर',
  startDate: new Date('10/07/2015'),
  endDate: null,
  expandable: true,
...
export const workExperience: ILocalization<Array<ICompanyExperience>> = {
